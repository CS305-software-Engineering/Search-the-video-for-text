...
const audio_transcribe = require('../../../../server/controllers/AudioTranscription/audio_transcribe');

describe('audio_transcribe', function () {
    it('transcriber should return string', function () {
