...
describe('audio_transcribe', function () {
    it('transcriber should return string  (phrase missing)', function () {
        audio_transcribe.transcriber('server/test/controllers/AudioProcessing/assets/sample_audio.wav', undefined, "en-us")
            .then(transcriptions => {
